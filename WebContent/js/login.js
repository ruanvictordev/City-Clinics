...
formlog.addEventListener("submit", e=>{
	//Formulário de login
	e.preventDefault();
	if(contatolog.value === ""){alert("O campo E-MAIL OU TELEFONE não pode estar vazio!");}
	if(senhalog.value.length < 8){alert("O campo SENHA precisa de no mínimo 8 caracteres!");}
